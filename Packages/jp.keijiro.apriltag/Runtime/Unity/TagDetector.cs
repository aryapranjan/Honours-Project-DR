...
public sealed class TagDetector : System.IDisposable
{
    ...
    public void ProcessImage
      (ReadOnlySpan<Color32> image, Vector2 focalLength,
       Vector2 focalCenter, float tagSize)
    {
        ImageConverter.Convert(image, _image);
    ...
    {
        var focalLength = _image.Width / 2 / Mathf.Tan(fov / 2);
        var focalCenter = new Vector2(_image.Width, _image.Height) / 2;
